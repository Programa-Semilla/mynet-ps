...
*Numbering is stable.* Resolved entries are struck through in place, never removed or renumbered. A
...
- **The client must be told** that "Ana R." reads her *"únicamente el primer nombre, sin apellidos"*
