...
export const attendeeVerifications = pgTable('attendee_verifications', identityTokenColumns())
 ...
 */
export const attendeePasswordResets = pgTable('attendee_password_resets', identityTokenColumns())
