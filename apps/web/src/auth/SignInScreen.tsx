    ...
    <main className="flex min-h-screen items-center justify-center bg-surface px-4 py-10">
      <div className="w-full max-w-md rounded-lg bg-surface-raised p-6 shadow-card sm:p-8">
        <header className="mb-6">
          {/*
            T041 (010) — the stacked lockup: mark above the heading, in the **navy** colourway
            for this light card (FR-826).

            The board draws this arrangement itself. What it must not become is the board's
            raster lockup dropped in whole: this heading is the product name as live text, and on
            **this** screen it is the `<h1>` — the only one of the five where that is so. An
            image cannot be a heading, so the mark sits above it and stays decorative.
          */}
