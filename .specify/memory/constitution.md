...
before phase 010's specification is written. Follows the precedent of 3.2.0 and 3.3.0 — the
...
redefined, nothing delivered is retracted, and no work performed under 3.3.0 is invalidated.** It is
...
Register changes:
  ...
  - 2 and 4. Unchanged in substance; both now block phase **011** rather than 010, because the
    roadmap's 010 is split (below). Entry 4 becomes materially cheaper once UAT exists — it has
    never been answerable without a running product at a real screen width.

Delivery-plan change recorded here because it changes which entries block what, not because the
roadmap is governance:
  - The roadmap's **010 — Launch Readiness** is split. **010** becomes UAT deployment and
    pre-public hardening, and is fully unblocked by this amendment. **011** becomes the validation
    pass and production, and remains blocked by entries 2 and 4. The halves were split because
...
blocks phase 010**, and what remains open blocks phase 011 or nothing.
...
2. **Real brand mark and application icons.** No logo exists in the repository; the only images are
   ...
   not any single feature. *Narrowed 2026-08-10 in 3.4.0*: it blocks phase **011**, not 010, and is
   now the open item most worth starting early, because it is the only one whose cost is elapsed
...
**Version**: 3.4.0 | **Ratified**: 2026-08-04 | **Last Amended**: 2026-08-10
