...
ALTER TABLE "admin_audit_entries" ADD COLUMN "subject_event_id" uuid;--> statement-breakpoint
...
CREATE INDEX "sessions_event_room_starts_at_idx" ON "sessions" USING btree ("event_id","room_id","starts_at");--> statement-breakpoint
