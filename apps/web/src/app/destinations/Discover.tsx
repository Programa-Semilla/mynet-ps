...
/**
 * Discover — structurally present, carrying no product content in this slice (FR-023).
 ...
 */
export const Discover = () => <DestinationPlaceholder destination={destinationFor('/discover')!} />
