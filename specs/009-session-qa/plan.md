...
| **VI. Web-first, offline explicit** | PASS — nothing cached, every write refused rather than queued. | **PASS with one deviation — see Complexity Tracking.** FR-756a is not met and the plan recommends withdrawing it. |
